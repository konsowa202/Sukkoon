...
const translations = {
  en: {
    ...
    "search.pricing.psychiatrist": "Psychiatrist from 650 EGP",
    "search.pricing.note": "* Prices vary by case and multiple packages are available",
  ...
  ar: {
    ...
    "search.pricing.psychiatrist": "طبيب سيكاتري من ٦٥٠ ج.م",
    "search.pricing.note": "* الأسعار تختلف حسب الحالة وتوجد باقات متنوعة",
