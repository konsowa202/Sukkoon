...
export const metadata: Metadata = {
  ...
  description: "سكون: منصة التواصل مع نخبة من أطباء ومعالجي الصحة النفسية. معاك خطوة بخطوة لعلاج الاكتئاب، القلق، والتوتر.",
  keywords: "صحة نفسية, علاج نفسي, اكتئاب, قلق, توتر, وسواس قهري, إدمان, استشارات أسرية, دكتور نفسي, معالج نفسي, سكون",
  generator: "v0.app",
}
