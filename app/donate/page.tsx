...
import { Heart, Loader2, Upload, CheckCircle2, User, Globe } from "lucide-react"
                    ...
                    <Card className="p-8 border-primary/10 shadow-xl space-y-8">
                        ...
                        {type === 'specific_doctor' && (
                            <div className="space-y-2">
                                <Label>{isArabic ? "اختر الطبيب" : "Select Doctor"}</Label>
                                <Select onValueChange={setSelectedDoctorId} value={selectedDoctorId}>
                                    <SelectTrigger className="h-12 rounded-xl">
                                        <SelectValue placeholder={isArabic ? "اختر طبيباً من القائمة" : "Select a doctor"} />
                                    </SelectTrigger>
                                    <SelectContent>
                                        {doctors.map(doc => (
